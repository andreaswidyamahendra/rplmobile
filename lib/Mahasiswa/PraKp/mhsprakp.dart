...
import 'package:flutter_sikp/Mahasiswa/PraKp/ajukanprakp.dart';
import 'package:flutter_sikp/Mahasiswa/PraKp/detailprakp.dart';
...
class _DbPraKpState extends State<DbPraKp> {
  Future<List> getData() async{
    final response= await http.get("http://10.0.2.2/crudsikp/getmhsprakp.php");
